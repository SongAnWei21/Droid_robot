...
# ============================== 路径与运行配置 ==============================
# 【请修改此路径】指向你的实际文件
XML_PATH = "/home/saw/droidup/Droid_robot/droidup_mujoco/assets/droidup/e1/E1_23dof.xml"  # E1 机器人的 xml 描述文件
ONNX_POLICY_PATH = "/home/saw/droidup/Droid_robot/Droid_real/policles/model_3.onnx"
MOTION_FILE_PATH = "/home/saw/droidup/Droid_robot/Droid_real/motion/dance3.npz"
    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while viewer.is_running() and time.time() - start < simulation_duration:
            ...
            if counter % control_decimation == 0: # 50Hz 控制计算
                ...
                timestep += 1  # 永远累加，依靠 frame_idx 强制取模循环
